...
def basicOpenAICompletion(temperature, model_name, chatlog, customer_profile=None, chat_history=None, context=None, user_question=None, functions=None, function_call=None):
